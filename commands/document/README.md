...
## Purpose
The $cmd command defines a reusable workflow for AI-assisted document work.
...
## Usage
Use this command when the primary intent is to document. Pair it with a relevant [skill](../../skills/README.md) and validation [checklist](../../checklists/README.md).
