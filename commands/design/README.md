...
## Purpose
The $cmd command defines a reusable workflow for AI-assisted design work.
...
## Usage
Use this command when the primary intent is to design. Pair it with a relevant [skill](../../skills/README.md) and validation [checklist](../../checklists/README.md).
