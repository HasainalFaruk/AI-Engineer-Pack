...
## Purpose
Use this checklist before merging or releasing mcp transport documentation or implementation work.

## Readiness checklist
- [ ] The design explicitly covers JSON-RPC 2.0, stdio, Streamable HTTP, sessions, cancellation.
