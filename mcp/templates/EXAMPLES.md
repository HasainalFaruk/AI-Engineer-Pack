...
## Purpose
These examples show how mcp templates applies to real MCP engineering work.

## Practical example
A team uses the tool-definition template to standardize customer-case search. The completed spec defines schema fields, tenant filtering, max results, redaction rules, timeout behavior, structured errors, and OpenAI/Claude usage notes.
