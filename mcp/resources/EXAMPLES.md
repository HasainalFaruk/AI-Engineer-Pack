...
## Purpose
These examples show how mcp resources applies to real MCP engineering work.

## Practical example
A monorepo server exposes service architecture notes, latest build logs, and source files as resources. The client displays provenance and refuses to combine private branch resources into public issue comments.
