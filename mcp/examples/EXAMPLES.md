...
## Purpose
These examples show how mcp examples applies to real MCP engineering work.

## Practical example
A release-readiness server exposes build logs and risk reports as resources, smoke-test and release-ticket actions as tools, and a release-summary prompt. OpenAI Agents use the remote server during CI review; Claude Code uses a local server for workspace inspection.
