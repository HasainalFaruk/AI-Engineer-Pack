...
## Purpose
Show practical MCP architectures that combine clients, servers, tools, resources, prompts, transport, security, OpenAI integration, and Claude integration.
...
## When to use
Use this module when planning a real implementation and you need concrete patterns rather than protocol definitions.

## When not to use
Do not copy an example without adapting identity, authorization, data boundaries, deployment model, and operational controls.
...
2. Identify the MCP responsibilities: release readiness, support triage, developer workflows, OpenAI agents, Claude Code.
