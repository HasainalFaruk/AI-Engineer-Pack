...
## Purpose
Collect production engineering guidance for designing, testing, deploying, observing, and governing MCP systems across clients and servers.
...
## When to use
Use this module before implementation begins, during review, and before production release of any MCP integration.

## When not to use
Do not use best practices as a substitute for protocol-specific design; pair them with the client, server, transport, tools, resources, and security modules.
...
2. Identify the MCP responsibilities: minimal capabilities, contract tests, performance budgets, observability, governance.
