...
## Purpose
Use this checklist before merging or releasing mcp servers documentation or implementation work.

## Readiness checklist
- [ ] The design explicitly covers capability boundaries, tool schemas, resource URIs, prompt discovery, server-side authorization.
