...
## Purpose
These examples show how mcp tools applies to real MCP engineering work.

## Practical example
A deployment-preview tool accepts a branch name and environment enum. The client requires approval, the server checks deployment rights, the result returns the preview URL and logs, and failures include remediation guidance without exposing credentials.
