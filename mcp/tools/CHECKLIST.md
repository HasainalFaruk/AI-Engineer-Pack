...
## Purpose
Use this checklist before merging or releasing mcp tools documentation or implementation work.

## Readiness checklist
- [ ] The design explicitly covers input schemas, side effects, approval policy, structured results, audit records.
