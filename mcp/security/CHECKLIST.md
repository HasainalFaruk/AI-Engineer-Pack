...
## Purpose
Use this checklist before merging or releasing mcp security documentation or implementation work.

## Readiness checklist
- [ ] The design explicitly covers authentication, authorization, consent, prompt-injection defense, audit logging.
