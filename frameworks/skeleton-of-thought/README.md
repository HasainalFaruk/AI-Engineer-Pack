...
## Purpose
The Skeleton of Thought framework structures prompts so AI assistants understand context, objectives, reasoning expectations, output format, and quality criteria.
...
## Example
`	ext
Use the Skeleton of Thought framework to design a reliable implementation plan. Inspect repository context first, follow existing conventions, include verification, and summarize tradeoffs.
`
