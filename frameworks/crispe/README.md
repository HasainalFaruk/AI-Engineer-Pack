...
## Purpose
The CRISPE framework structures prompts so AI assistants understand context, objectives, reasoning expectations, output format, and quality criteria.
...
## Example
`	ext
Use the CRISPE framework to design a reliable implementation plan. Inspect repository context first, follow existing conventions, include verification, and summarize tradeoffs.
`
